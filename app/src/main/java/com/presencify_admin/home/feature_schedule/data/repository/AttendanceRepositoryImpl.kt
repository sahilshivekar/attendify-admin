...
import com.presencify_admin.home.feature_schedule.data.remote.dto.request.MarkAttendanceRequest
import com.presencify_admin.home.feature_schedule.data.remote.dto.request.RemoveAttendanceRequest
import com.presencify_admin.home.feature_schedule.data.remote.dto.request.SendAttendanceReportRequest
...
class AttendanceRepositoryImpl @Inject constructor(
    ...
    override suspend fun createAttendance(requestBody: CreateAttendanceRequest): Response<PresencifyApiResponse<AttendanceDto?>> =
        attendanceApi.createAttendance(requestBody)

    override suspend fun addStudentsAttendance(requestBody: AddStudentsAttendanceRequest): Response<PresencifyApiResponse<List<AttendanceStudentDto>?>> =
        attendanceApi.addStudentsAttendance(requestBody)

    override suspend fun updateStudentAttendance(requestBody: UpdateStudentAttendanceRequest): Response<PresencifyApiResponse<AttendanceStudentDto?>> =
        attendanceApi.updateStudentAttendance(requestBody)

    override suspend fun removeAttendance(requestBody: RemoveAttendanceRequest): Response<PresencifyApiResponse<String?>> =
