...
class TimetableRepositoryImpl(
    ...
    override suspend fun getTimetableById(timetableId: Int): Response<PresencifyApiResponse<TimetableDto>> {
        return timetableApi.getTimetableById(timetableId)
    }

    override suspend fun addTimetable(requestBody: AddTimetableRequest): Response<PresencifyApiResponse<TimetableDto>> {
        return timetableApi.addTimetable(requestBody)
    }

    override suspend fun updateTimetable(requestBody: UpdateTimetableRequest): Response<PresencifyApiResponse<TimetableDto>> {
        return timetableApi.updateTimetable(requestBody)
    }

    override suspend fun removeTimetable(timetableId: Int): Response<PresencifyApiResponse<Unit>> {
