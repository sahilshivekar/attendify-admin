...
import com.presencify_admin.common.data.remote.dto.response.toScheme
...
class UpdateSchemeUseCase @Inject constructor(
    private val schemeRepository: SchemeRepository
) {
    operator fun invoke(requestBody: UpdateSchemeRequest): Flow<Resource<Scheme?>> = flow {

        emit(Resource.Loading())

        val response = runCatching {
            schemeRepository.updateScheme(requestBody)
        }
