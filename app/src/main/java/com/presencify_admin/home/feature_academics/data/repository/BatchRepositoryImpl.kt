...
import com.presencify_admin.home.feature_academics.data.remote.BatchApi
...
class BatchRepositoryImpl @Inject constructor(
    ...
    override suspend fun getAllBatches(
        semesterNumber: Int?,
        branchId: Int?,
        academicStartYear: Int?,
        academicEndYear: Int?,
    ...
    override suspend fun addBatch(requestBody: AddBatchRequest): Response<PresencifyApiResponse<BatchDto?>> =
        batchApi.addBatch(requestBody)

    override suspend fun updateBatch(requestBody: UpdateBatchRequest): Response<PresencifyApiResponse<BatchDto?>> =
        batchApi.updateBatch(requestBody)

    override suspend fun removeBatch(batchId: Int): Response<PresencifyApiResponse<String?>> =
        batchApi.removeBatch(batchId)

    override suspend fun getBatchById(batchId: Int): Response<PresencifyApiResponse<BatchDto?>> =
