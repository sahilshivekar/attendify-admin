...
interface SemesterApi {
    ...
    suspend fun addSemester(@Body requestBody: AddSemesterRequest): Response<PresencifyApiResponse<SemesterDto?>>

    @PUT("api/v1/semester/admin/update")
    suspend fun updateSemester(@Body requestBody: UpdateSemesterRequest): Response<PresencifyApiResponse<SemesterDto?>>

    @DELETE("api/v1/semester/admin/remove")
    suspend fun removeSemester(@Query("id") semesterId: Int): Response<PresencifyApiResponse<String?>>

    @GET("api/v1/semester/admin/get-courses-of-semester")
    suspend fun getCoursesOfSemester(@Query("semesterId") semesterId: Int): Response<PresencifyApiResponse<List<SemesterDto>?>>

    @GET("api/v1/semester/admin/get-semester-by-id")
    suspend fun getSemesterById(@Query("semesterId") semesterId: Int): Response<PresencifyApiResponse<SemesterDto?>>
}