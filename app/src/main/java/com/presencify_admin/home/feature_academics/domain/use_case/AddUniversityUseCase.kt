...
import com.presencify_admin.common.data.remote.dto.response.toUniversity
...
class AddUniversityUseCase @Inject constructor(
    private val universityRepository: UniversityRepository
) {
    operator fun invoke(requestBody: AddUniversityRequest): Flow<Resource<University>> = flow {

        emit(Resource.Loading<University>())

        val response = runCatching {
            universityRepository.addUniversity(requestBody)
        }
