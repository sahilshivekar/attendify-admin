package com.presencify_admin.home.feature_users.data.repository
...
//        confirmPassword: String,
    ...
    override suspend fun updateStudentDetails(requestBody: UpdateStudentDetailsRequest): Response<PresencifyApiResponse<StudentDto>> {
        return studentApi.updateStudentDetails(requestBody)
    }

    override suspend fun updateStudentPassword(requestBody: UpdateStudentPasswordRequest): Response<PresencifyApiResponse<StudentDto>> {
    ...
    override suspend fun removeStudentImage(studentId: Int): Response<PresencifyApiResponse<StudentDto>> {
        return studentApi.removeStudentImage(studentId)
    }

    override suspend fun removeStudent(studentId: Int): Response<PresencifyApiResponse<Unit>> {
        return studentApi.removeStudent(studentId)
    }

    override suspend fun getStudentDetailsById(studentId: Int): Response<PresencifyApiResponse<StudentDto>> {
        return studentApi.getStudentDetailsById(studentId)
    }

    override suspend fun addStudentToSemester(requestBody: AddStudentToSemesterRequest): Response<PresencifyApiResponse<StudentSemesterDto>> {
        return studentApi.addStudentToSemester(requestBody)
    }

    override suspend fun removeStudentFromSemester(studentSemesterId: Int): Response<PresencifyApiResponse<Unit>> {
        return studentApi.removeStudentFromSemester(studentSemesterId)
    }

    override suspend fun addStudentToDivision(requestBody: AddStudentToDivisionRequest): Response<PresencifyApiResponse<StudentDivisionDto>> {
        return studentApi.addStudentToDivision(requestBody)
    }

    override suspend fun changeStudentDivision(requestBody: ChangeStudentDivisionRequest): Response<PresencifyApiResponse<StudentDivisionDto>> {
        return studentApi.changeStudentDivision(requestBody)
    }

    override suspend fun addStudentToBatch(requestBody: AddStudentToBatchRequest): Response<PresencifyApiResponse<StudentBatchDto>> {
        return studentApi.addStudentToBatch(requestBody)
    }

    override suspend fun changeStudentBatch(requestBody: ChangeStudentBatchRequest): Response<PresencifyApiResponse<StudentBatchDto>> {
        return studentApi.changeStudentBatch(requestBody)
    }

    override suspend fun getStudentSemestersById(studentId: Int): Response<PresencifyApiResponse<List<StudentSemesterDto>?>> {
    ...
    override suspend fun addStudentToDropout(requestBody: AddDropoutRequest): Response<PresencifyApiResponse<DropoutDto?>> {
    ...
    override suspend fun getDropoutById(dropoutId: Int): Response<PresencifyApiResponse<DropoutDto?>> {
        return studentApi.getDropoutById(dropoutId)
    }

    override suspend fun getDropoutDetailsOfStudent(studentId: Int): Response<PresencifyApiResponse<List<DropoutDto>?>> {
        return studentApi.getDropoutDetailsOfStudent(studentId)
    }

    override suspend fun addStudentFcmToken(requestBody: AddStudentFcmTokenRequest): Response<PresencifyApiResponse<StudentFCMTokenDto?>> {
        return studentApi.addStudentFcmToken(requestBody)
    }

    override suspend fun updateStudentFcmToken(requestBody: UpdateStudentFcmTokenRequest): Response<PresencifyApiResponse<StudentFCMTokenDto?>> {
        return studentApi.updateStudentFcmToken(requestBody)
    }

    override suspend fun removeStudentFcmToken(studentId: Int): Response<PresencifyApiResponse<Unit>> {
