...
import com.presencify_admin.home.feature_users.data.remote.StaffApi
...
class StaffRepositoryImpl(
    ...
    override suspend fun getStaffById(staffId: Int): Response<PresencifyApiResponse<StaffDto>> {
...
//            confirmPasswordBody,
    ...
    override suspend fun updateStaffDetails(requestBody: UpdateStaffDetailsRequest): Response<PresencifyApiResponse<StaffDto>> {
        return staffApi.updateStaffDetails(requestBody)
    }

    override suspend fun updateStaffPassword(requestBody: UpdateStaffPasswordRequest): Response<PresencifyApiResponse<StaffDto>> {
    ...
    override suspend fun removeStaff(staffId: Int): Response<PresencifyApiResponse<Unit>> {
        return staffApi.removeStaff(staffId)
    }

    override suspend fun removeImage(staffId: Int): Response<PresencifyApiResponse<StaffDto>> {
        return staffApi.removeImage(staffId)
    }

    override suspend fun getTeachingSubjects(staffId: Int): Response<PresencifyApiResponse<List<TeacherTeachesDto>?>> {
        return staffApi.getTeachingSubjects(staffId)
    }

    override suspend fun addTeachingSubject(requestBody: AddTeachingSubjectRequest): Response<PresencifyApiResponse<TeacherTeachesDto>> {
        return staffApi.addTeachingSubject(requestBody)
    }

    override suspend fun removeTeachingSubject(teacherSubjectId: Int): Response<PresencifyApiResponse<Unit>> {
