...
import com.presencify_admin.home.feature_users.presentation.add_to_dropout.components.StudentCard

@Composable
fun AddToDropoutScreen(
    modifier: Modifier = Modifier,
    state: AddToDropoutState,
    onEvent: (AddToDropoutEvent) -> Unit,
        ...
        Column(
            ...
            PresencifyDropDownMenuBox(
                ...
                onDropDownVisibilityChanged = {
                    onEvent(
                        AddToDropoutEvent.AcademicYearDropdownVisibilityChanged(
                            it
                        )
                    )
                },
                ...
                onSelectItem = {
                    onEvent(AddToDropoutEvent.AcademicYearChanged(it))
                },
                label = "Dropout year"
            )
                ...
                LazyColumn {
                    items(
                        ...
                        StudentCard(
                            ...
                            onAddToDropout = { onEvent(AddToDropoutEvent.AddStudentToDropout(student.id)) },
