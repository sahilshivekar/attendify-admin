...
@ComponentPreview
@Composable
fun PresencifyButtonPreview() {
    PreviewWrapper {
        PresencifyButton(onClick = {}) { Text(text = "Login") }
    }
}

@ComponentPreview
@Composable
fun PresencifyTextButtonPreview() {
    PreviewWrapper {
        PresencifyTextButton(onClick = {}) { Text(text = "cancel") }
    }
}

@ComponentPreview
@Composable
fun PresencifyOutlinedButtonPreview() {
    PreviewWrapper {
        PresencifyOutlinedButton(onClick = {}) { Text(text = "cancel") }
    }
}