...
import com.edu.wiet_admin.academics.data.CourseApi
import com.edu.wiet_admin.academics.data.CourseRepositoryImpl
import com.edu.wiet_admin.academics.domain.repository.CourseRepository
import com.edu.wiet_admin.academics.domain.use_case.AddCourseToBranchWithSemesterNumberUseCase
import com.edu.wiet_admin.academics.domain.use_case.AddCourseUseCase
import com.edu.wiet_admin.academics.domain.use_case.GetCourseByIdUseCase
import com.edu.wiet_admin.academics.domain.use_case.GetCoursesUseCase
import com.edu.wiet_admin.academics.domain.use_case.RemoveCourseFromBranchWithSemesterNumberUseCase
import com.edu.wiet_admin.academics.domain.use_case.RemoveCourseUseCase
import com.edu.wiet_admin.academics.domain.use_case.UpdateCourseUseCase
