...
import com.edu.wiet_admin.users.data.StudentApi
import com.edu.wiet_admin.users.data.StudentRepositoryImpl
import com.edu.wiet_admin.users.domain.repository.StudentRepository
import com.edu.wiet_admin.users.domain.use_case.AddStudentToBatchUseCase
import com.edu.wiet_admin.users.domain.use_case.AddStudentToDivisionUseCase
import com.edu.wiet_admin.users.domain.use_case.AddStudentToSemesterUseCase
import com.edu.wiet_admin.users.domain.use_case.AddStudentUseCase
import com.edu.wiet_admin.users.domain.use_case.ChangeStudentBatchUseCase
import com.edu.wiet_admin.users.domain.use_case.ChangeStudentDivisionUseCase
import com.edu.wiet_admin.users.domain.use_case.GetStudentBatchesByIdUseCase
import com.edu.wiet_admin.users.domain.use_case.GetStudentDetailsByIdUseCase
import com.edu.wiet_admin.users.domain.use_case.GetStudentDivisionsByIdUseCase
import com.edu.wiet_admin.users.domain.use_case.GetStudentSemestersByIdUseCase
import com.edu.wiet_admin.users.domain.use_case.GetStudentsUseCase
import com.edu.wiet_admin.users.domain.use_case.RemoveStudentFromSemesterUseCase
import com.edu.wiet_admin.users.domain.use_case.RemoveStudentImageUseCase
import com.edu.wiet_admin.users.domain.use_case.RemoveStudentUseCase
import com.edu.wiet_admin.users.domain.use_case.UpdateStudentDetailsUseCase
import com.edu.wiet_admin.users.domain.use_case.UpdateStudentImageUseCase
import com.edu.wiet_admin.users.domain.use_case.UpdateStudentPasswordUseCase
