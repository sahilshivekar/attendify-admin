...
package com.edu.wiet_admin.users.presentation.search_student
...
import com.edu.wiet_admin.common.presentation.components.WietNoResultsIndicator
import com.edu.wiet_admin.common.presentation.components.WietSearchBar
import com.edu.wiet_admin.users.presentation.search_student.components.ModalBottomSheetForSearchStudentScreen
import com.edu.wiet_admin.users.presentation.search_student.components.StudentCard
import com.edu.wiet_admin.users.utils.StudentUtils
        ...
        students?.let {
            when {
                students.loadState.refresh is LoadState.NotLoading && students.itemCount == 0 -> {
                    WietNoResultsIndicator()
                }

                students.loadState.hasError -> {
                    WietNoResultsIndicator(text = "Some error occurred while fetching students")
                }
