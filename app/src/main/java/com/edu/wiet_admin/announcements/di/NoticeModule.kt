...
import com.edu.wiet_admin.announcements.data.NoticeApi
import com.edu.wiet_admin.announcements.data.NoticeRepositoryImpl
import com.edu.wiet_admin.announcements.domain.repository.NoticeRepository
import com.edu.wiet_admin.announcements.domain.use_case.AddNoticeUseCase
import com.edu.wiet_admin.announcements.domain.use_case.DeleteNoticeUseCase
import com.edu.wiet_admin.announcements.domain.use_case.GetNoticeByIdUseCase
import com.edu.wiet_admin.announcements.domain.use_case.GetNoticesUseCase
import com.edu.wiet_admin.announcements.domain.use_case.UpdateNoticeUseCase
