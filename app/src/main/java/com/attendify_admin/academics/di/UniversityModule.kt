...
import com.attendify_admin.academics.data.UniversityApi
import com.attendify_admin.academics.data.UniversityRepositoryImpl
import com.attendify_admin.academics.domain.repository.UniversityRepository
import com.attendify_admin.academics.domain.use_case.AddUniversityUseCase
import com.attendify_admin.academics.domain.use_case.GetUniversityByIdUseCase
import com.attendify_admin.academics.domain.use_case.GetUniversitiesUseCase
import com.attendify_admin.academics.domain.use_case.RemoveUniversityUseCase
import com.attendify_admin.academics.domain.use_case.UpdateUniversityUseCase
