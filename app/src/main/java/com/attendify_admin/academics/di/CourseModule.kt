...
import com.attendify_admin.academics.data.CourseApi
import com.attendify_admin.academics.data.CourseRepositoryImpl
import com.attendify_admin.academics.domain.repository.CourseRepository
import com.attendify_admin.academics.domain.use_case.AddCourseToBranchWithSemesterNumberUseCase
import com.attendify_admin.academics.domain.use_case.AddCourseUseCase
import com.attendify_admin.academics.domain.use_case.GetCourseByIdUseCase
import com.attendify_admin.academics.domain.use_case.GetCoursesUseCase
import com.attendify_admin.academics.domain.use_case.RemoveCourseFromBranchWithSemesterNumberUseCase
import com.attendify_admin.academics.domain.use_case.RemoveCourseUseCase
import com.attendify_admin.academics.domain.use_case.UpdateCourseUseCase
