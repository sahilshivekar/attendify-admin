...
import com.attendify_admin.common.data.remote.dto.response.toBranch
...
class UpdateBranchUseCase @Inject constructor(
    ...
    operator fun invoke(requestBody: UpdateBranchRequest): Flow<Resource<Branch?>> = flow {

        emit(Resource.Loading())

        val response = runCatching {
            branchRepository.updateBranch(requestBody)
        }
