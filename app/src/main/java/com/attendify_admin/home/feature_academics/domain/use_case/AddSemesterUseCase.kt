...
class AddSemesterUseCase @Inject constructor(
    ...
    operator fun invoke(requestBody: AddSemesterRequest): Flow<Resource<Semester>> = flow {

        emit(Resource.Loading<Semester>())

        val response = runCatching {
            semesterRepository.addSemester(requestBody)
        }
