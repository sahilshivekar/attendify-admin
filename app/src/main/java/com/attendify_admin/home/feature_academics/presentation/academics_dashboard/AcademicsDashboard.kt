...
import com.attendify_admin.home.feature_academics.navigation.AcademicsDestination.ManageBatch
import com.attendify_admin.home.feature_academics.navigation.AcademicsDestination.ManageBranch
import com.attendify_admin.home.feature_academics.navigation.AcademicsDestination.ManageCourse
import com.attendify_admin.home.feature_academics.navigation.AcademicsDestination.ManageDivision
import com.attendify_admin.home.feature_academics.navigation.AcademicsDestination.ManageScheme
import com.attendify_admin.home.feature_academics.navigation.AcademicsDestination.ManageSemester
import com.attendify_admin.home.feature_academics.navigation.AcademicsDestination.ManageUniversity
import com.attendify_admin.home.feature_academics.presentation.academics_dashboard.components.AcademicsGroupingContainer
import com.attendify_admin.home.feature_academics.presentation.academics_dashboard.components.CurriculumStructureContainer
