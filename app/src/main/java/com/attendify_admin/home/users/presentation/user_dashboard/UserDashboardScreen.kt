package com.attendify_admin.home.users.presentation.user_dashboard
    ...
    Column(
        ...
        Column(
            ...
            Row(
                ...
                AttendifyOptionRow(
                    onClick = { onAssignStudentToSemesterClick() },
                    showDivider = false,
                ...
                AttendifyOptionRow(
                    onClick = { onRemoveStudentFromSemesterClick() },
                    showDivider = false,
            ...
            Row(
                ...
                AttendifyOptionRow(
                    onClick = {onAssignStudentToDivisionClick() },
                    showDivider = false,
                ...
                AttendifyOptionRow(
                    onClick = { onModifyStudentDivisionClick() },
                    showDivider = false,
            ...
            Row(
                ...
                AttendifyOptionRow(
                    onClick = {onAssignStudentToBatchClick() },
                    showDivider = false,
                ...
                AttendifyOptionRow(
                    onClick = { onModifyStudentBatchClick() },
                    showDivider = false,
        ...
        Column(
            ...
            Row(
                ...
                AttendifyOptionRow(
                    onClick = {onUnassignSubjectToTeacher() },
                    showDivider = false,
