package com.attendify_admin.home.users.navigation
...
import com.attendify_admin.home.users.presentation.add_staff.AddStaffScreen
import com.attendify_admin.home.users.presentation.add_staff.AddStaffViewModel
import com.attendify_admin.home.users.presentation.add_student.AddStudentScreen
import com.attendify_admin.home.users.presentation.add_student.AddStudentViewModel
import com.attendify_admin.home.users.presentation.assign_student_to_batch.AssignStudentBatchScreen
import com.attendify_admin.home.users.presentation.assign_student_to_batch.AssignStudentBatchViewModel
import com.attendify_admin.home.users.presentation.assign_student_to_division.AssignStudentDivisionScreen
import com.attendify_admin.home.users.presentation.assign_student_to_division.AssignStudentDivisionViewModel
import com.attendify_admin.home.users.presentation.assign_student_to_semester.AssignStudentSemesterScreen
import com.attendify_admin.home.users.presentation.assign_student_to_semester.AssignStudentSemesterViewModel
import com.attendify_admin.home.users.presentation.assign_subject_to_teacher.AssignSubjectTeacherScreen
import com.attendify_admin.home.users.presentation.assign_subject_to_teacher.AssignSubjectTeacherViewModel
import com.attendify_admin.home.users.presentation.modify_student_division.ModifyStudentDivisionScreen
import com.attendify_admin.home.users.presentation.modify_student_division.ModifyStudentDivisionViewModel
import com.attendify_admin.home.users.presentation.search_staff.SearchStaffScreen
import com.attendify_admin.home.users.presentation.search_staff.SearchStaffViewModel
import com.attendify_admin.home.users.presentation.search_student.SearchStudentScreen
import com.attendify_admin.home.users.presentation.search_student.SearchStudentViewModel
import com.attendify_admin.home.users.presentation.student_details.StudentDetailsScreen
import com.attendify_admin.home.users.presentation.student_details.StudentDetailsViewModel
import com.attendify_admin.home.users.presentation.unassign_subject_to_teacher.UnassignSubjectTeacherScreen
import com.attendify_admin.home.users.presentation.unassign_subject_to_teacher.UnassignSubjectTeacherViewModel
import com.attendify_admin.home.users.presentation.user_dashboard.UserDashboardScreen
