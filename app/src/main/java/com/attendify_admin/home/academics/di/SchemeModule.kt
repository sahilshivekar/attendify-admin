...
import com.attendify_admin.home.academics.data.SchemeApi
import com.attendify_admin.home.academics.data.SchemeRepositoryImpl
import com.attendify_admin.home.academics.domain.repository.SchemeRepository
import com.attendify_admin.home.academics.domain.use_case.AddSchemeUseCase
import com.attendify_admin.home.academics.domain.use_case.GetSchemeByIdUseCase
import com.attendify_admin.home.academics.domain.use_case.GetSchemesUseCase
import com.attendify_admin.home.academics.domain.use_case.RemoveSchemeUseCase
import com.attendify_admin.home.academics.domain.use_case.UpdateSchemeUseCase
