package com.attendify_admin.announcements.di

import com.attendify_admin.announcements.data.NoticeApi
import com.attendify_admin.announcements.data.NoticeRepositoryImpl
import com.attendify_admin.announcements.domain.repository.NoticeRepository
import com.attendify_admin.announcements.domain.use_case.AddNoticeUseCase
import com.attendify_admin.announcements.domain.use_case.DeleteNoticeUseCase
import com.attendify_admin.announcements.domain.use_case.GetNoticeByIdUseCase
import com.attendify_admin.announcements.domain.use_case.GetNoticesUseCase
import com.attendify_admin.announcements.domain.use_case.UpdateNoticeUseCase
