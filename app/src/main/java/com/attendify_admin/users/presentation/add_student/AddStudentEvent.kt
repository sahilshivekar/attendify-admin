...
sealed class AddStudentEvent {
    ...
    data class AcademicStatusChanged(val newAcademicStatus: String) : AddStudentEvent()
    ...
    data class AcademicStatusDropDownVisibilityChanged(val newVisibility: Boolean) : AddStudentEvent()
