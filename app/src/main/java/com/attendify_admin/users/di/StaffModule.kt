package com.attendify_admin.users.di

import com.attendify_admin.users.data.StaffApi
import com.attendify_admin.users.data.StaffRepositoryImpl
import com.attendify_admin.users.domain.repository.StaffRepository
import com.attendify_admin.users.domain.use_case.AddStaffUseCase
import com.attendify_admin.users.domain.use_case.AddTeachingSubjectUseCase
import com.attendify_admin.users.domain.use_case.GetStaffByIdUseCase
import com.attendify_admin.users.domain.use_case.GetStaffUseCase
import com.attendify_admin.users.domain.use_case.GetTeachingSubjectsUseCase
import com.attendify_admin.users.domain.use_case.RemoveImageUseCase
import com.attendify_admin.users.domain.use_case.RemoveStaffUseCase
import com.attendify_admin.users.domain.use_case.RemoveTeachingSubjectUseCase
import com.attendify_admin.users.domain.use_case.UpdateStaffDetailsUseCase
import com.attendify_admin.users.domain.use_case.UpdateStaffImageUseCase
import com.attendify_admin.users.domain.use_case.UpdateStaffPasswordUseCase
